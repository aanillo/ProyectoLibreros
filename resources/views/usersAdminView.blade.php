...
<body class="flex flex-col min-h-screen text-white font-[Brawler]">
    ...
    <main class="flex-grow flex flex-col items-center bg-white text-black px-6 mt-48">
        ...
        <div class="flex-grow flex flex-row items-center gap-4 mb-8">
            ...
            <a href="{{ route('insertUser') }}" class="btnHome bg-amber-200 text-[#322411] font-bold border-2 border-solid border-black px-10 py-1.5 rounded-md hover:bg-yellow-600">Registrar</a>
        </div>
            ...
            <tbody>
                <template x-for="user in paginatedUsers" :key="user.id">
                    <tr class="border-b text-black text-lg bg-amber-100">
                        ...
                        <td class="px-4 py-2" x-text="user.fecha_nacimiento"></td>
                        <td class="px-4 py-2" x-text="user.localidad"></td>
                        <td class="px-4 py-2" x-text="user.rol"></td>
                        <td class="px-4 py-2" x-text="user.fecha_registro"></td>
                        <td class="px-4 py-2">
